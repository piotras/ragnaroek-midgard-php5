/* $Id: mgd_pageelement.h 6995 2003-05-15 21:03:07Z david $
...
extern MGD_FUNCTION(ret_type, create_page_element_content, (type param));
#endif /* HAVE_MIDGARD_MULTILANG */
extern MGD_FUNCTION(ret_type, update_page_element, (type param));
#if HAVE_MIDGARD_MULTILANG
extern MGD_FUNCTION(ret_type, update_page_element_content, (type param));
#endif /* HAVE_MIDGARD_MULTILANG */
extern MGD_FUNCTION(ret_type, delete_page_element, (type param));
extern MGD_FUNCTION(ret_type, delete_page_element_tree, (type param));
#if HAVE_MIDGARD_MULTILANG
extern MGD_FUNCTION(ret_type, delete_page_element_content, (type param));
#endif /* HAVE_MIDGARD_MULTILANG */
